...
from models import mar_cache as mar
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mar_huge', type=str, metavar='MODEL',
    ...
    parser.add_argument('--num_iter', default=32, type=int,
                        help='number of autoregressive iterations to generate an image')

    parser.add_argument('--output_dir', default='/mnt/data1/yanfeihong/projs/lazymar/runtime',
                        help='path where to save, empty for no saving')

    parser.add_argument('--num_images', default=50000, type=int,
                        help='number of images to generate')
    parser.add_argument('--cfg', default=3.25, type=float, help="classifier-free guidance")
    ...
    parser.add_argument('--lazy_mar', action='store_true', help='enable LazyMAR acceleration')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/mnt/data1/yanfeihong/projs/lazymar/data/ImageNet_5k', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='pretrained_models/mar/mar_huge',
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(
        args.output_dir,
        f"{args.model}",
        f"iter_{args.num_iter}_lazy{args.lazy_mar}_bsz{args.eval_bsz}"
    )
